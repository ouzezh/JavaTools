package com.ozz.tools.dbvisualizer;
...
public class DbVisualizerPwd {
    private static String paramString2 = "qinda"; //qinda是在源码中发现的key
    ...
    public static String encrypt(String paramString1, String paramString2,
        ...
        try {
            ...
            byte[] arrayOfByte2 = Base64.getEncoder().encode(
                    localCipher.doFinal(arrayOfByte1));
